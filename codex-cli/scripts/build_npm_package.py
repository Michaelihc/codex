#!/usr/bin/env python3
"""Stage and optionally package the @michaelihc/codex-multi npm module."""
...
CODEX_NPM_NAME = "@michaelihc/codex-multi"

# `npm_name` is the local optional-dependency alias consumed by `bin/codex.js`.
# The underlying package published to npm is always `@michaelihc/codex-multi`.
CODEX_PLATFORM_PACKAGES: dict[str, dict[str, str]] = {
    "codex-linux-x64": {
        "npm_name": "@michaelihc/codex-multi-linux-x64",
        "npm_tag": "linux-x64",
    ...
    "codex-linux-arm64": {
        "npm_name": "@michaelihc/codex-multi-linux-arm64",
        "npm_tag": "linux-arm64",
    ...
    "codex-darwin-x64": {
        "npm_name": "@michaelihc/codex-multi-darwin-x64",
        "npm_tag": "darwin-x64",
    ...
    "codex-darwin-arm64": {
        "npm_name": "@michaelihc/codex-multi-darwin-arm64",
    ...
    "codex-win32-x64": {
        "npm_name": "@michaelihc/codex-multi-win32-x64",
        "npm_tag": "win32-x64",
    ...
    "codex-win32-arm64": {
        "npm_name": "@michaelihc/codex-multi-win32-arm64",
        "npm_tag": "win32-arm64",
